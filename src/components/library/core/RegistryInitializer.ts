...
import DetailCardsGadget from '../gadgets/dashboard/DetailCardsGadget/index';
...
import ProjectPortfolioGadget from '../gadgets/dashboard/ProjectPortfolioGadget';
import { StatsGadget } from '../gadgets/dashboard/StatsGadget';
import TimelineGadget from '../gadgets/dashboard/TimelineGadget/index';
...
WidgetRegistry.register('image-upload-drawing', ImageUploadWithDrawingWidget);
  ...
  GadgetRegistry.register('detail-cards-gadget', DetailCardsGadget);
  GadgetRegistry.register('timeline-gadget', TimelineGadget);
  ...
  GadgetRegistry.register('project-portfolio-gadget', ProjectPortfolioGadget);
