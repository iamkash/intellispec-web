...
export const createWidgetFactory = (gadget: any) => ({
  ...
  'image-upload-with-drawing': (props: any) => React.createElement(ImageUploadWidget as any, { ...props, id: props.fieldPath }),
  'image-upload-drawing': (props: any) => React.createElement(ImageUploadWidget as any, { ...props, id: props.fieldPath }),
